  ...
  return (
    ...
    >
      ...
      <p className="tg-pricing-note">
        Prices are in USD; applicable taxes are added at checkout. Paid plans renew monthly or
        annually until cancelled. Credits are used for finished video renders; previewing, editing,
        and subtitle files do not use credits. <Link href="/terms">Terms</Link> ·{' '}
