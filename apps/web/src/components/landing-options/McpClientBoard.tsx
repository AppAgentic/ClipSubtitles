...
const CLIENT_ICON_PATHS: Record<Exclude<McpClientId, 'other'>, string> = {
...
function ClientIcon({ id }: { id: McpClientId }) {
  return (
    <svg className="tg-client-icon" viewBox="0 0 24 24" aria-hidden="true">
      {id === 'other' ? (
        <path d="M5 4.5h5v5H5v-5Zm9 0h5v5h-5v-5ZM9.5 14h5v5h-5v-5ZM7.5 9.5V12h4v2m5-4.5V12h-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      ) : (
