  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-20">
      ...
      <div className="mt-8 space-y-5 text-[15px] leading-7 text-ink-dim">
        ...
        <p>Original videos and finished files follow the retention windows shown in your workspace settings. Deleting a project removes its associated media. We do not sell your personal information.</p>
