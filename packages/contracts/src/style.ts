...
export const FontWeightSchema = z.union([z.literal(400), z.literal(500), z.literal(600), z.literal(700), z.literal(800), z.literal(900)]);
export const TextTransformSchema = z.enum(['none', 'uppercase']);
export const HighlightModeSchema = z.enum(['none', 'word']);
export const TextAlignSchema = z.enum(['left', 'center', 'right']);

export const StylePresetIdSchema = z.enum(['clean', 'bold-pop', 'lower-third', 'karaoke', 'minimal']);
